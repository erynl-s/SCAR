...
def load_image(fpath):
    ...
    return itk_img#, img # REMOVING ANTS IMAGE
...
def intensity_normalization(itk_img):
    '''
    normalize intensity values of itk image to range [0,1]
    '''
    intensity_filter = sitk.RescaleIntensityImageFilter()
    intensity_filter.SetOutputMaximum(255.0)
    intensity_filter.SetOutputMinimum(0.0)
    norm_itk = intensity_filter.Execute(itk_img)
