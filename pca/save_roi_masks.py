...
lpath = '/home/eryn/SynthSegOutput/sri24_spgr_RAI_ROI/sri24_spgr_RAI_ROI_seg.nii.gz'
label_atlas = sitk.ReadImage(lpath)

dfpath = '/home/eryn/SynthSeg/data/synthseg_labels.csv' 
df = pd.read_csv(dfpath)

savepath = '/home/eryn/Atlas/roi_masks/'
