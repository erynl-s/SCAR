...
parser.add_argument('--region', type=int, help='synthseg region value')
parser.add_argument('--var_ret', type=float, help='variability retained in PCA model', default=1)
args = parser.parse_args()

#load region mask
mask_dir = '/home/eryn/Atlas/roi_masks/'
...
save_dir = '/home/eryn/save_pca_synthseg/pca_models_velo_50/'
...
#save pca model 
f = open(save_dir + 'sri24_spgr_RAI_synthseg_' + str(args.region), 'wb')
