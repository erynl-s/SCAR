...
labels_path='/home/eryn/SynthSeg/data/synthseg_labels.csv' #path to csv file with atlas labels
velo_path=/home/eryn/Desktop/IXI_nonlin_velo_fields_reduced #path to folder with velocity fields
